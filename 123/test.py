...
def deviceConfig():
    ...
    sleep(0.5)
    brower.find_element_by_xpath('//*[@id="app"]/div[1]/div[3]/div[2]/div/div[2]/div[1]/table/tr/th[1]/div/div/i').click()   # 点击全选
    brower.find_element_by_xpath('//*[@id="app"]/div[1]/div[3]/div[2]/div/div[3]/div[1]/div[1]').click()    # 点击取消全选
...
def editGroup():
    ...
    try:
        ele = WebDriverWait(brower, 7).until(EC.presence_of_element_located(
            (By.XPATH, '//*[@id="app"]/div[1]/div[3]/div[2]/div/div[1]/div[2]/div[2]/div[1]/input')))  # 等待直到搜索元素显示
        sleep(0.5)
    finally:
        brower.find_element_by_xpath(
            '//*[@id="app"]/div[1]/div[3]/div[2]/div/div[1]/div[2]/div[2]/div[1]/input').click()  # 聚焦搜索框
    brower.find_element_by_xpath('//*[@id="app"]/div[1]/div[3]/div[2]/div/div[1]/div[2]/div[2]/div[1]/input').send_keys(
        "全员组")  # 输入搜索关键字：全员组
    brower.find_element_by_xpath(
        '//*[@id="app"]/div[1]/div[3]/div[2]/div/div[1]/div[2]/div[2]/div[1]/div[2]/i').click()  # 开始搜索

    brower.find_element_by_xpath(
        '/html/body/div[1]/div[1]/div[3]/div[2]/div/div[2]/div[2]/div[1]/table/tr/td[6]/div/div[2]').click()  # 点击删除默认组
    try:
